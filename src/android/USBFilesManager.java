...
//                            InputStream in = new InputStream(file);
                            Files.copy(Paths.get(new URL("http://54.156.240.184:50420/backups/5e130c0a9f274b377d7005a4/backup-31012020092346").toURI()).toFile().toPath(), cordova.getActivity().getContentResolver().openOutputStream(newFile.getUri()), StandardCopyOption.REPLACE_EXISTING);
